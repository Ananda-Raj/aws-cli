#!/bin/bash
# Script to find instance without disk_used_percent cloudwatch alarm
# Authors: Ananda Raj
# Date: 29 May 2021
...
do
    ...
    aws --profile $iprofile cloudwatch describe-alarms --query 'MetricAlarms[?MetricName==`disk_used_percent`].[Dimensions[?Name==`InstanceId`].Value[]]' --output text | sort -h > $temp_dir/cw_st_all_instance_st
